...
tmux send-keys -t dev:2.1 "cd ~/Dropbox/python" "Enter"
tmux send-keys -t dev:2.2 "cd ~/Dropbox/python" "Enter"
tmux send-keys -t dev:2.3 "cd ~/Dropbox/python" "Enter"
tmux new-window -t dev:3
tmux select-window -t dev:3
tmux split-window -t dev:3 -h
tmux rename-window webdev
tmux send-keys -t dev:3.1 "cd /var/www/" "Enter"
tmux send-keys -t dev:3.2 "cd /var/www/" "Enter"
tmux select-window -t dev:1
tmux attach -t dev
